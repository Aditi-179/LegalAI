      ...
      <section className="auth-hero">
        <div className="auth-intro">
          ...
          <p className="hero-copy">
            Login first, then continue into the main app screen with sidebar and
            account footer.
          </p>
        ...
        <form className="panel field-grid auth-panel" onSubmit={onSubmit}>
          <div className="panel-copy">
            ...
            <p>
              {mode === "login"
                ? "Access your assistant, documents, drafts, and saved history."
        ...
        <div className="panel auth-side">
          ...
          <p>
            The workspace opens with Assistant, Documents, Drafts, and History
            in the sidebar.
          </p>
          <div className="auth-flow-list">
            ...
            <div className="result-box">
              User account block pinned at the bottom.
            </div>
            <div className="result-box">
              Cleaner dashboard-style layout after sign in.
            </div>
          </div>
        </div>
      </section>
